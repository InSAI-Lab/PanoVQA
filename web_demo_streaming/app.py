...
<center><font size=3>This WebUI is based on Qwen2-VL, developed by Alibaba Cloud.</center>""")
        gr.Markdown("""<center><font size=3>This WebUI is based on Qwen2-VL.</center>""")
    ...
    (Note: This demo is subject to the Qwen2-VL license agreement. We strictly recommend against spreading or allowing others to spread harmful info including\
