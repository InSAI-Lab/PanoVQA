...
sys.path.append("/hkfs/home/project/hk-project-pai00053/wd1434/programmes/PLM")
sys.path.append("/home/hk-project-pai00053/wd1434/programmes/PLM/plm-finetune")
sys.path.append("/home/hk-project-pai00053/wd1434/programmes/PLM/plm-finetune/plm/train")
...
from plm.train.attentionFormer import modify_qwen2_5_vl_vision_attention
...
def main():
    ...
    # Load adaptor_config.json, support parent directory lookup
    adaptor_config = {}
    try:
        with open(os.path.join(args.model_path, "adaptor_config.json"), "r") as f:
    ...
    # Inject adapter
    modify_qwen2_5_vl_vision_attention(adaptor_config.get("adaptor_name"), config.vision_config, adaptor_config)
    ...
    # except:
    processor = AutoProcessor.from_pretrained("Qwen/Qwen2.5-VL-3B-Instruct", min_pixels=args.min_pixels, max_pixels=args.max_pixels)
