...
<center><font size=3>This WebUI is based on Qwen2.5-VL, developed by Alibaba Cloud.</center>""")
        gr.Markdown("""<center><font size=3>This WebUI is based on Qwen2.5-VL.</center>""")
...
(Note: This demo is subject to the Qwen2.5-VL license agreement. We strictly recommend against spreading or allowing others to spread harmful info including\
hate speech, violence, pornography, and fraud.)""")
